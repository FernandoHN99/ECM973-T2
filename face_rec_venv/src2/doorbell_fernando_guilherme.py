...
def warm_up_encoding():
    ...
    dummy_image = cv2.imread('dummy_image.jpg')
    small_frame = cv2.resize(dummy_image, (0, 0), fx=0.25, fy=0.25)
    dummy_locations = face_recognition.face_locations(small_frame)
    if dummy_locations:
        _ = face_recognition.face_encodings(small_frame, dummy_locations)
